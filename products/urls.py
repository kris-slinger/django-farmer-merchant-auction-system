...
from products.views import FarmerSpecificProductView, ProductDetailView, ProductFileDetailView, ProductFileView, ProductView, ProductCategoryView

urlpatterns = [
    path('', ProductView.as_view()),
    path('farmer/', FarmerSpecificProductView.as_view()),
